    ...
    <div className={`min-h-screen ${darkMode ? "bg-zinc-900" : "bg-neutral-50"} py-8 sm:py-12`}>
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <div className="relative p-6 sm:p-8">
            ...
            <div className="flex items-start justify-between mb-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-purple-500 font-semibold text-sm sm:text-base">
                    Strategic giving
                  </p>
                </div>
              </div>
            ...
            <p className={`text-sm sm:text-base leading-relaxed ${
              ...
              Join our community of monthly champions. Your sustained support enables long-term planning and greater impact.
            </p>

            {/* Action Button - Desktop Only */}
            <button
              onClick={() => document.getElementById('amount-section')?.scrollIntoView({ behavior: 'smooth' })}
              className="hidden sm:flex items-center gap-2 mt-6 text-purple-500 font-semibold hover:gap-3 transition-all group"
            >
        ...
        >
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={index} className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-full bg-purple-500/10 border-2 border-purple-500 flex items-center justify-center flex-shrink-0 mt-0.5">
          ...
          <div className="flex sm:hidden items-center justify-center gap-2 mt-6 text-sm text-purple-500">
              ...
              <input
                ...
                className={`w-full pl-12 pr-4 py-4 text-2xl font-bold rounded-xl border-2 outline-none transition-all ${
                  darkMode
                    ...
                    : "bg-white border-zinc-200 text-zinc-900 placeholder-zinc-300 focus:border-purple-500 focus:ring-4 focus:ring-purple-100"
                }`}
              />
            </div>
          </div>
          ...
          <select
            ...
            className={`w-full px-4 py-3 rounded-lg border-2 outline-none transition-all font-semibold ${
              darkMode
                ...
                : "bg-white border-zinc-200 text-zinc-900 focus:border-purple-500 focus:ring-4 focus:ring-purple-100"
            }`}
          >
        ...
        >
          ...
          <div className="space-y-4">
            {[
              { icon: Calendar, text: "Flexible monthly donation scheduling" },
              { icon: TrendingUp, text: "Detailed impact reports and analytics" },
              { icon: Users, text: "Exclusive monthly champion community" },
              { icon: Shield, text: "Full control to pause or modify anytime" }
            ].map((feature, index) => {
