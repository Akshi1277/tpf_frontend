              ...
              {recentTransactions.map((txn, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`p-3 sm:p-4 md:p-5 transition-all relative overflow-hidden group ${
                  ...
                  >
                    ...
                    <div className="flex items-start sm:items-center gap-3 sm:gap-4 relative z-10">
                      {/* Colorful Icon */}
                      <div className={`w-12 h-12 sm:w-14 sm:h-14 rounded-xl flex items-center justify-center flex-shrink-0 transition-all group-hover:scale-110 ${
                        typeColor === "blue" 
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex flex-wrap items-center gap-1.5 sm:gap-2 mb-1.5 sm:mb-2">
                          <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium truncate max-w-[150px] sm:max-w-none ${
                            typeColor === "blue"
                      ...
                      <div className="text-right flex-shrink-0">
                        <p className={`text-lg sm:text-xl md:text-2xl font-bold mb-0.5 sm:mb-1 ${
                          typeColor === "blue"
