    ...
    const [donations, setDonations] = useState([
        ...
        date: "2024-11-10",
        status: "pending",
        referenceNumber: "RTGS123456789",
        submittedOn: "2024-11-10T10:30:00"
        },
        {
        id: "ODN002",
        method: "NEFT",
        ...
        submittedOn: "2024-11-08T14:20:00",
        approvedOn: "2024-11-09T09:15:00"
        }
    ])
    ...
    const handleSubmit = () => {
        const newDonation = {
        id: `ODN${String(donations.length + 1).padStart(3, '0')}`,
        method: formData.method,
        amount: parseFloat(formData.amount),
        date: formData.transactionDate || formData.chequeDate,
        status: "pending",
        referenceNumber: formData.referenceNumber || formData.utrNumber || formData.chequeNumber,
    ...
    return (
        ...
        {/* Main Content */}
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 sm:pt-12 pb-8 sm:pb-12">
                    ...
                    {donations.map((donation, index) => (
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
                            ...
                            <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${
                                ...
                                {paymentMethods.find(m => m.name === donation.method)?.icon && 
                                (() => {
                                    const Icon = paymentMethods.find(m => m.name === donation.method).icon
                ...
                {!selectedMethod ? (
                    ...
                    <div className="p-6 sm:p-8">
                        ...
                        <div>
                            ...
                            {selectedMethod.id !== "cheque" ? (
                                ...
                                <div>
                                    <label className={`block text-sm font-semibold mb-2 ${darkMode ? "text-zinc-300" : "text-gray-700"}`}>
                                    {selectedMethod.id === "rtgs" ? "UTR Number" : 
                                    selectedMethod.id === "imps" ? "Transaction ID" : 
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className={`text-xs ${darkMode ? "text-blue-400" : "text-blue-700"}`}>
                                        ...
                                        notification once it's approved or if additional information is needed. Please ensure
                    ...
                    <div className="flex items-center justify-end gap-4 mt-8 pt-6 border-t border-gray-200 dark:border-zinc-800">
                        ...
                        <button
                            ...
                            disabled={!formData.donorName || !formData.email || !formData.phone || !formData.amount}
                            className={`flex items-center gap-2 px-8 py-3 rounded-xl font-semibold transition-all shadow-lg ${
                                !formData.donorName || !formData.email || !formData.phone || !formData.amount
