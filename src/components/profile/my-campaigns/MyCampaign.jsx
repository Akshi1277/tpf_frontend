      ...
      >
        ...
        <div className="mt-6 pt-4 border-t border-gray-100 dark:border-zinc-700">
          <p className={`text-xs text-center font-semibold ${darkMode ? "text-purple-400" : "text-purple-600"}`}>
            Direct fund transfer will be processed by our finance team. Please Contact us if any other queries.
          </p>
        </div>
      </motion.div>
    );
        ...
        <div className="p-4 sm:p-5 lg:p-6">
          ...
          {isMyCampaign ? (
            ...
            <div className="flex gap-2">
              ...
              <button
                className={`py-2 sm:py-2.5 px-3 cursor-pointer sm:px-4 rounded-lg font-semibold transition-all ${showDonateButton
