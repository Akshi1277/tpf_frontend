            ...
            <div className="flex flex-col w-full md:w-auto md:min-w-[400px]">
              ...
              <div className="flex">
                <input
                  ...
                  className={`flex-1 px-1 py-3 -ml-5 border rounded-lg focus:outline-gray-500 focus:ring-2 ${
                    darkMode
                      ? 'bg-zinc-800 border-zinc-700 text-white placeholder-zinc-500'
                      : 'bg-white border-gray-300 text-gray-900 placeholder-gray-400'
                  }`}
                />
                <button className="px-6 ml-2 py-3 bg-black hover:bg-gray-900 text-white rounded-r-lg transition-colors flex items-center justify-center cursor-pointer">
