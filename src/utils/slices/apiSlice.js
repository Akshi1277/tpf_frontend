...
export const apiSlice = createApi({
  ...
  tagTypes: ["CMS", "Campaign", "User", "Wishlist", "RecentTransactions", "PeopleHelped", "Leaderboard", "Comments", "MyDonations", "MyApplications", "Vouchers", "Blog", "FAQ", "Organization", "CampaignRequest", "Fundraiser","Jobs","CampaignDonors"],
  endpoints: (builder) => ({
